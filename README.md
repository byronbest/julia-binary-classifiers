...
Use `julia top_v.jl` to find (and then copy to all run*.h5: `or i in 2 3 4 5 6 7 8 ; do cp run1.h5 run$i.h5 ; done`) the best subset of features, and re-run the above to continue search.
